# telnet_server
Реализована shared library telnet сервер c функциями дебага приложения (Легковесная удаленная система для отладки приложения, там где gdb нельзя использовать) 
